...
// Findstars constructor for text
Findstars::Findstars(string filepath) {
...
//
//
void Findstars::search() {



}

Point2f Findstars::getMCE(int i) {
	return mc[i];
}
...
// FINDSTREAKS
Findstreaks::Findstreaks(string filepath, int thresh, int lineThresh, int minLineLength, int maxLineGap) {
